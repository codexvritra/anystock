...
/**
 * Coarse city labels for the stats page ("705 walkers across 138 cities") without
 * sending anyone's position to a geocoding service. Nearest major city within 60 km;
 * beyond that the catch is counted under a ~50 km grid label so it still counts once.
 */
